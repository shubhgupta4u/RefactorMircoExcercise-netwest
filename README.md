...
If the full git history is not included it will impact the assessment negatively. Your project will be rejected so this is very important. It is recommended to create a fork of the repository and use it as your starting point with all the existing commit history.
